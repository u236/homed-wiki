...
!!! warning ""
    ...
    Карта регистров работает только для [устройств](/modbus/devices/) типа `customController`. Карта регистров поддерживает только [типовые способности устройств](/common/exposes/#_1). Специальные способности не поддерживаются.
