...
| `rfc`   | использование протокола RFC2217 для управления параметрами порта при сетевом соединении |
| `debug` | вывод в лог дампов обмена данными с устройствами |

!!! info ""

    Сервис может работать с большим количеством портов и устройств. Максимальное количество портов - _255_.
